...
async def _learner_summary(db: AsyncSession, learner: Learner) -> dict:
    ...
    return {
        ...
        "learning_count": loop_progress["released_learning_count"],
        "familiar_count": loop_progress["released_familiar_count"],
        "mastered_count": loop_progress["released_mastered_count"],
